...
async def run_experiment_task1(labels_csv=None,
    ...
    """
    Run an experiment with 72 trials across 3 casino types:
    - Casino 1: Symmetric [0.5, 0.5]
    - Casino 2: Asymmetric [0.75, 0.25]
    - Casino 3: Asymmetric reversed [0.25, 0.75]

    Each casino has 24 trials for a total of 72 trials per subject.
    Points are +1 for a win and -1 for a loss. Goal is to maximize total points.

    Args:
        labels_csv: Path to CSV file with casino labels (optional)
