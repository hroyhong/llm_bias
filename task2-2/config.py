...
EXPERIMENT_CONFIG = {
    ...
    "rewards": {
        ...
        "loss": -1  # Reward for losing (-1 loss)
    }
}

# System message for LLM
SYSTEM_MESSAGE = """You are going to visit three different casinos (named 1, 2, and 3) 24 times each. Each casino owns two slot machines which stochastically give you either 1 point (a win) or -1 point (a loss) with different win probabilities. Your goal is to maximize the total points gained within 72 visits.
