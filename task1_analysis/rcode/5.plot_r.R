...
df <- read.csv("/Users/hroyhong/Desktop/llm0412/task2/result/parallel_mle_result_complete.csv", header = TRUE)
head(df)
summary(df)
...
ggsave("/Users/hroyhong/Desktop/llm0412/task2/result/confirmation_bias.png", plot = p, width = 4, height = 4, dpi = 300)
