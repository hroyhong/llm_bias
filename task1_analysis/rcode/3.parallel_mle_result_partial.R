...
dat<-read.csv('/Users/hroyhong/Desktop/llm0412/task2/data/combined_partial.csv')
...
write.table(res,"/Users/hroyhong/Desktop/llm0412/task2/result/parallel_mle_result_partial.csv",row.names=FALSE,col.names=TRUE,sep=",")