...
data_file_path <- '/Users/hroyhong/Desktop/llm0412/task1/data/combined_p.csv'
...
ggsave(plot = accuracy_plot, filename = paste0(output_path, 'casino_2_3_accuracy_plot_p.pdf'), width = 7, height = 4)
