...
dat<-read.csv('/Users/hroyhong/Desktop/llm0412/task1/data/combined_p_n.csv')
...
write.table(res,"/Users/hroyhong/Desktop/llm0412/task1/result/parallel_mle_result_p_n.csv",row.names=FALSE,col.names=TRUE,sep=",")