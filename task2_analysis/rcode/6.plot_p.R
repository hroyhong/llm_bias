...
df <- read.csv("/Users/hroyhong/Desktop/llm0412/task1/result/parallel_mle_result_p_n.csv", header = TRUE)
head(df)
summary(df)
...
ggsave("/Users/hroyhong/Desktop/llm0412/task1/result/llm_learning_rates_p_n.png", plot = p, width = 4, height = 4, dpi = 300)
